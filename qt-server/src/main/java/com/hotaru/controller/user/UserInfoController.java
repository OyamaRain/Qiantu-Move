...
public class UserInfoController {
    ...
    @PostMapping("/apply")
    @Tag(name = "个人中心")
    @Operation(summary = "用户申请成为搬家师傅")
    public Result applyMover(@RequestBody MoverApplyDTO moverApplyDTO) {
        log.info("用户申请成为搬家师傅：{}", moverApplyDTO);
        userInfoService.applyMover(moverApplyDTO);
